...
(function () {
    ...
    var loadChat = function (cb) {
        ...
        $.get("https://rawgit.com/lilstump/basicBot/master/lang/langIndex.json", function (json) {
    ...
    var basicBot = {
        ...
        settings: {
            ...
            commandLiteral: "!",
            blacklists: {
                NSFW: "https://rawgit.com/lilstump/basicBot-customization/master/blacklists/ExampleNSFWlist.json",
                OP: "https://rawgit.com/lilstump/basicBot-customization/master/blacklists/ExampleOPlist.json"
            }
        },
        room: {
            users: [],
            ...
            minecraftCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat("/me Connect using this ip Ultramc.net");
                    }
                }
            },
